...
#include "armor_detector/armor.hpp" //把armor_detector中include文件夹内的armor.hpp头文件包含在内
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  auto detector = std::make_unique<Detector>(binary_thres, detect_color, l_params, a_params); //使用智能指针进行传参
